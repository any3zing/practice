...
const float SCORE_THRESHOLD = 0.02;
const float NMS_THRESHOLD = 0.04;
...
int main(int argc, char **argv) {
    ...
    cv::Mat frame = cv::imread("first.jpg"); // Замените "image.jpg" на имя вашего изображения
    if (frame.empty()) {
    ...
    cv::waitKey(0); // Ждать нажатия клавиши
